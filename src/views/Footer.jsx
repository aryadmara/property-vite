...
function footer() {
    return ( 
        <div className="flex flex-col md:flex-row mx-6 md:mx-60 my-6 md:my-20">
            ...
            <section className="flex mt-3 cursor-pointer">
            ...
            <div className="flex-1 pl-0 md:pl-11 mt-6 md:mt-0">
