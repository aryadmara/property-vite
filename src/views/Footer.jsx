...
function footer() {
    return ( 
        <div className="flex mx-60 my-20">
            ...
            <h2 className=" text-2xl "><span className=" font-extrabold text-[#486e81]">Rocket</span><span className="text-[#486e81]">lister</span></h2>
            ...
            <section className="flex mt-3">
                <TiSocialFacebook className="bg-[#486e81] w-6 h-6 rounded-full text-white mr-2"/>
                <TiSocialTwitter className="bg-[#486e81] w-6 h-6 rounded-full text-white mr-2"/>
                <TiSocialYoutube className="bg-[#486e81] w-6 h-6 rounded-full text-white mr-2"/>
                <TiSocialLinkedin className="bg-[#486e81] w-6 h-6 rounded-full text-white mr-2"/>

            </section>
            </div>
            <div className="flex-1 ">
                <h2 className="text-2xl text-[#486e81] ">567 Mottson Lane</h2>
                <h4 className="text-sm mt-2">Beach Ville, CA 12345</h4>
                <h4 className="text-sm mt-4">Powered By: <span className=" font-extrabold text-[#486e81]">Rocket</span><span className="text-[#486e81]">lister</span></h4>
                <section className="flex mt-3">
                <BiSolidTachometer className="w-7 h-7  text-[#486e81] mr-2" />
                <AiFillAppstore className="w-7 h-7  text-[#486e81] mr-2" />
