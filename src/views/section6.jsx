  ...
  return(
    ...
    <div className="pt-8">
      <div className="flex gap-3 items-center ">
        <div className="border-b border-gray-400 w-4 md:w-72 h-1 "></div>
        <div >
            <p className=" w-62 text-[#3A8CB1] text-4xl font-medium">Amenities</p>
        </div>
        <div></div>
      </div>
      <div className="flex flex-wrap md:px-72 gap-3 m-2">
